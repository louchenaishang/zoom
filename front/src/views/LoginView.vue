    ...
    <el-col :span="24">
      <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px"
        ...
        <el-form-item prop="captcha">
          <el-col :span="18">
            <el-input type="text" v-model="ruleForm2.captcha" auto-complete="off" placeholder="图形验证码"
                      :maxlength="4"></el-input>
          </el-col>
          <el-col :span="6">
            <captcha :captchaId="ruleForm2.captchaId" scene="login" @click.native.prevent="refreshCaptchaId"
